<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/activity/index.html";i:1524547530;s:75:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/layout.html";i:1524460663;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/header.html";i:1524460666;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/footer.html";i:1524460665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	...
	<div class="panel">
		<div class="panel-body">
			<div class="pad-all row">
				<div class="col-lg-8">
					<a class="btn btn-default <?php if($tags_on == '0'): ?>btn-success<?php endif; ?>" href="<?php echo url('activity/index'); ?>/tags/0/shop/<?php echo $type_on; ?>">全部</a>
					...
					<a class="btn btn-default <?php if($tags_on == $v['id']): ?>btn-success<?php endif; ?>" href="<?php echo url('activity/index'); ?>/tags/<?php echo $v['id']; ?>/shop/<?php echo $type_on; ?>"><?php echo $v['name']; ?></a>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
					...
					<tbody id="tablelists">
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
							<tr id="tr<?php echo $v['id']; ?>">
								...
								<td><img src="<?php echo $v['qrb']; ?>" style="max-width:5em;" onclick="seeImg('<?php echo $v['qrb']; ?>')"/></td>
								...
								<td>
									...
									<?php if($v['type'] == '1'): ?>
									<span class="btn btn-danger btn-sm" onclick="hot(<?php echo $v['id']; ?>,<?php echo $tags_on; ?>,0)">我是爆款</span>
									<?php else: ?>
									<button class="btn btn-warning btn-sm" onclick="hot(<?php echo $v['id']; ?>,<?php echo $tags_on; ?>,1)">设为爆款</button>
									<?php endif; ?>
							...
							<tr>
							<td colspan="3"></td>
							<td colspan="4">ToB链接：<?php echo $v['toburl']; ?></td>
							</tr>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</tbody>
				</table>
...
function search(){
	...
	location.href="<?php echo url('activity/index'); ?>?keyword="+keyword
}
...
function hot(id,tags,status){
	$.post("<?php echo url('activity/hot'); ?>",{id:id,tags:tags,status:status},function(data){
		if(data.status==1){
