<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/system/user.html";i:1524460667;s:75:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/layout.html";i:1524460663;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/header.html";i:1524460666;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/footer.html";i:1524460665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<tr>
							...
							<td><?php if(in_array(($v['rule']), explode(',',"3,4"))): ?><?php echo $v['shop']['shopname']; else: ?><?php echo $v['name']; endif; ?></td>
