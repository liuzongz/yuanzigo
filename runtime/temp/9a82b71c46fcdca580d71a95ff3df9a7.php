<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/shouqianba/insert.html";i:1524460666;s:75:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/layout.html";i:1524460663;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/header.html";i:1524460666;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/footer.html";i:1524460665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
		...
		<div class="row" style="background-color:#fff">
			...
			<div class="col-lg-10 bord-lft">
				<div class="pad-all mar-all">
					<!--  -->
<form method="post" enctype="multipart/form-data" action="import"  class="text-center pad-all mar-all">  
	<input type="submit" value="导入数据" class="btn btn-lg btn-success"/>  
	<input type="file" name="excel" style="font-size: 18px;float: left;" />
</form>
				</div>
			</div>
		</div>
