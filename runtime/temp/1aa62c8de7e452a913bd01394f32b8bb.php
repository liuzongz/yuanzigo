<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/orders/index.html";i:1524460665;s:75:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/layout.html";i:1524460663;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/header.html";i:1524460666;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/footer.html";i:1524460665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
					...
					<tbody id="tablelists">
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
							<tr id="tr<?php echo $v['id']; ?>">
								...
								<td><?php echo $v['contact']; ?> <p>电话：<?php echo $v['tel']; ?></p></td>
								<td><?php echo $v['activity']['title']; ?></td>
								<td>【<?php echo $v['shopinfo']['shopname']; ?>】的小店</td>
								<td>
								<span class="pad-ver">x</span> <?php echo $v['total_num']; ?><br>
								</td>
