<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/data/shop.html";i:1524460663;s:75:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/layout.html";i:1524460663;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/header.html";i:1524460666;s:82:"/home/wwwroot/www.yuanzigo.com/public/../application/admin/view/public/footer.html";i:1524460665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<table class="table table-striped">
	...
	<tbody>
		<tr>
			<td>今日</td>
			<td><?php echo $reg['day1']; ?></td>
			<td><?php echo $login['day1']; ?></td>
		</tr>
		<tr>
			<td>昨日</td>
			<td><?php echo $reg['day2']; ?></td>
			<td><?php echo $login['day2']; ?></td>
		</tr>
		<tr>
			<td>本周</td>
			<td><?php echo $reg['day7']; ?></td>
			<td><?php echo $login['day7']; ?></td>
		</tr>
		<tr>
			<td>上周</td>
			<td><?php echo $reg['day14']; ?></td>
			<td><?php echo $login['day14']; ?></td>
		</tr>
		<tr>
			<td>本月</td>
			<td><?php echo $reg['day30']; ?></td>
			<td><?php echo $login['day30']; ?></td>
		</tr>
		<tr>
			<td>上月</td>
			<td><?php echo $reg['day60']; ?></td>
			<td><?php echo $login['day60']; ?></td>
		</tr>
	</tbody>
</table>
