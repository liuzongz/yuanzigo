<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/home/wwwroot/www.yuanzigo.com/public/../application/admin1801/view/orders/index.html";i:1522832733;s:79:"/home/wwwroot/www.yuanzigo.com/public/../application/admin1801/view/layout.html";i:1517976565;s:86:"/home/wwwroot/www.yuanzigo.com/public/../application/admin1801/view/public/header.html";i:1517976569;s:86:"/home/wwwroot/www.yuanzigo.com/public/../application/admin1801/view/public/footer.html";i:1517976569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
					...
					<tbody id="tablelists">
						<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
							<tr id="tr<?php echo $v['id']; ?>">
								...
								<td><?php echo $v['shopinfo']['shopname']; ?></td>
								<td>
								...
								<td>
									<button class="btn btn-sm btn-default" onclick="look(<?php echo $v['id']; ?>)">详情</button>
									<?php if($v['clearing'] == '0'): ?>
									<button class="btn btn-success btn-sm" onclick="clearing(<?php echo $v['id']; ?>)">结算</button>
									<?php else: ?>
									<span class="btn btn-default btn-sm" title="<?php echo date('Y-m-d H:i:s',$v['clearing']); ?>">已结算</span>
									<?php endif; ?>
								</td>
							</tr>
						<?php endforeach; endif; else: echo "" ;endif; ?>
...
function clearing(id){
	var url="<?php echo url('orders/setclearing'); ?>";
	layer.confirm('确定要对他进行结算吗？', {
		  btn: ['结算','不结算'] //按钮
		}, function(){
